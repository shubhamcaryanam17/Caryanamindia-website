      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600">
            Discover our events, workshops, and summits designed to help
            organizations accelerate with technology.
          </p>
        ...
        <div className="mt-12 flex flex-wrap items-center gap-4">
          ...
          <div className="ml-auto min-w-[240px] flex-1">
            <input
              value={search}
              onChange={(event) => setSearch(event.target.value)}
              placeholder="Search events"
              className="w-full rounded-full border border-slate-200 bg-white px-5 py-3 text-slate-900 outline-none transition-all duration-300 placeholder:text-slate-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
            />
          </div>
        </div>
        ...
        <div className="mt-12 grid gap-8 xl:grid-cols-2">
          {filteredEvents.map((event, index) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-3xl border border-orange-100 bg-white p-8 shadow-sm transition-all duration-500 hover:border-orange-400 hover:shadow-xl hover:shadow-orange-100"
            >
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="rounded-full border border-orange-200 bg-orange-50 px-4 py-2 text-xs font-bold uppercase tracking-[0.24em] text-orange-500">
                  {event.type}
                </div>
              </div>

              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-purple-50 p-5 text-sm text-slate-700">
                  <div className="flex items-center gap-2">
                ...
                <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-purple-50 via-white to-orange-50 p-5 text-sm text-slate-700">
                  <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => setSelectedEvent(event)}
                className="mt-7 inline-flex items-center justify-center rounded-full bg-orange-500 px-7 py-3 text-sm font-bold text-white shadow-lg shadow-orange-200 transition-all duration-300 hover:scale-105 hover:bg-orange-600"
              >
                View Details
              </button>
            </motion.article>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-7 grid gap-4 sm:grid-cols-2">
                  <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-orange-50 via-white to-purple-50 p-6">
                  ...
                  <div className="rounded-3xl border border-orange-100 bg-gradient-to-br from-purple-50 via-white to-orange-50 p-6">
                    <p className="text-sm font-bold uppercase tracking-[0.24em] text-orange-500">
                      Where
                    </p>
                    <p className="mt-4 text-lg font-bold text-black">
                ...
                <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="rounded-3xl border border-orange-100 bg-orange-50 p-4 text-sm text-slate-700">
                    <Sparkles className="inline h-4 w-4 text-orange-500" />
                    <span className="ml-2">
                      Premium experiences for enterprise teams
                    </span>
                  </div>

                  <button className="inline-flex items-center justify-center rounded-full bg-orange-500 px-7 py-3 text-sm font-bold text-white shadow-lg shadow-orange-200 transition-all duration-300 hover:scale-105 hover:bg-orange-600">
                    Register Now
                  </button>
                </div>
              </div>
